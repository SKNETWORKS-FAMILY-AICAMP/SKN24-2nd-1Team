...
---
- 김지원: 처음엔 모델 성능이 낮아 막막했지만, 여러 시도를 통해 결정트리의 하이퍼파라미터를 튜닝하며 성능과 해석력 사이의 최적점을 끝내 찾아냈습니다. 그 결과 정밀도를 6배 높이고 평잔_6M의 76%기여도를 입증했습니다. 비즈니스 로직에 맞춰 모델을 직접 설계하고 그 근거를 논리적으로 이해하는 경험을 할 수 있어서 유익했습니다. 
